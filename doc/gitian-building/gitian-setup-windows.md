...
The build script we'll be using is contained in the EncoCoin github repository ([contrib/gitian-build.py](https://github.com/encocoin-project/encocoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the EncoCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/EncoCoin-Project/EncoCoin/master/contrib/gitian-build.py
