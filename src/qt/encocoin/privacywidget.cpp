    ...
    ui(new Ui::PrivacyWidget)
{
    ...
    ui->btnTotalzXNK->setTitleClassAndText("btn-title-grey", tr("Total 0 zXNK"));
    ui->btnTotalzXNK->setSubTitleClassAndText("text-subtitle", tr("Show denominations of zXNK owned."));
    ui->btnTotalzXNK->setRightIconClass("ic-arrow");

    ui->btnCoinControl->setTitleClassAndText("btn-title-grey", tr("Coin Control"));
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", tr("Select XNK outputs to mint into zXNK."));
    ...
    ui->btnResetZerocoin->setTitleClassAndText("btn-title-grey", tr("Reset Spent zXNK"));
