    ...
    ui(new Ui::CoinControlXnkWidget)
{
    ...
    ui->labelTitle->setText("Select XNK Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("XNK");
    ...
    ui->labelValueAfter->setText("0.00 XNK");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 XNK");
    ui->labelValueFee->setText("0.00 XNK");
    ...
    connect(ui->btnEsc, &QPushButton::clicked, this, &CoinControlXnkWidget::close);
    connect(ui->btnCancel, &QPushButton::clicked, this, &CoinControlXnkWidget::close);
