    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your XNKs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept XNK delegation / Delegate XNK"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select XNK outputs to delegate.");
