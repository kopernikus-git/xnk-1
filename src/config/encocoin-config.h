/* src/config/encocoin-config.h.  Generated from encocoin-config.h.in by configure.  */
/* src/config/encocoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/encocoin-project/encocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EncoCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EncoCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "encocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://encocoin.org/"
